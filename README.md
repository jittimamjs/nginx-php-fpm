This is a fork of Ric Harvey's [nginx-php-fpm](https://gitlab.com/antonyharfield/nginx-php-fpm) modified with defaults for running Laravel out-of-the-box. Run inside your laravel directory:
```
